...
/**
 * Typed payload map for each RealtimeEvent.
 * Payloads are intentionally IDs-only — clients refetch full entities via REST.
 * Frontend: socket.on(RealtimeEvent.TASK_UPDATED, (p: RealtimeEventPayloads[RealtimeEvent.TASK_UPDATED]) => ...)
 */
